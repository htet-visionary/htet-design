          ...
          links={[
            {
              ...
              description: "Colors, typography, spacing, icons, radius, elevation, layout.",
            },
            {
              title: "Accessibility",
              href: `${designSystemBase}/accessibility`,
